    ...
    <Layout>
      <div className="bg-gray-100 min-h-screen">
        <div className="max-w-4xl mx-auto px-4 py-8">
          ...
          <p className="mb-4">
            At Zenmatix, we are dedicated to safeguarding your privacy and
            ...
            existing agreements directly established between you and Zenmatix.
          ...
          <p className="mb-4">
            At Zenmatix, we will only request personal information when it is
          ...
          <p className="mb-4">
            In the event that Zenmatix invites you to complete and submit an
          ...
          <p className="mb-4">
            It's important to note that while Zenmatix may track a visitor's
          ...
          <p className="mb-4">
            The purposes for which Zenmatix may utilize your personal
          ...
          <p className="mb-4">
            If you wish to be removed from any Zenmatix distribution list,
          ...
          <p className="mb-4">
            ...
            Zenmatix, you may receive telephone calls from us regarding new
          ...
          <p className="mb-4">
            The Zenmatix website may contain links to external websites,
            ...
            are not governed by Zenmatix's privacy policy. Zenmatix has no
          ...
          <p className="mb-4">
            ...
            Zenmatix's privacy practices and does not extend to the privacy
            policies or practices of third-party websites or features. Zenmatix
          ...
          <p className="mb-4">
            ...
            paramount at Zenmatix. We have implemented robust measures to
          ...
          <p className="mb-4">
            At Zenmatix, we remain committed to upholding the highest standards
          ...
          <p className="mb-4">
            ...
            Zenmatix remains fully compliant with the EU-US Privacy Shield
          ...
          <p className="mb-4">
            At Zenmatix, we are committed to maintaining the highest standards
          ...
          <p className="mb-4">
            Zenmatix is mandated to adhere to specific procedures when
          ...
          <p className="mb-4">
            In accordance with the Privacy Shield Principles, Zenmatix is
          ...
          <p className="mb-4">
            Zenmatix is subject to the investigative and enforcement authority
          ...
          <p className="mb-4">
            Zenmatix reserves the right to modify or supplement this Privacy
            Policy at its discretion. We encourage you to periodically review
            this section of Zenmatix’s website to stay informed of any updates.
